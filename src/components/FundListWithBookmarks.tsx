  ...
  return (
    <div>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <label className="flex min-w-0 max-w-xs flex-1 items-center gap-2 rounded-md border border-input bg-background px-3 py-2 text-foreground focus-within:ring-2 focus-within:ring-ring sm:max-w-sm">
          <SearchIcon />
          <input
            type="search"
            value={query}
            ...
            placeholder="搜尋基金名稱"
            className="min-w-0 flex-1 border-0 bg-transparent text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-0"
      ...
      <ul
        className="grid list-inside gap-2 text-muted-foreground sm:grid-cols-2 lg:grid-cols-3"
        role="list"
      >
